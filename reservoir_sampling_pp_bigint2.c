...
#include "reservoir_sampling_pp_bigint2.h"
...
PG_FUNCTION_INFO_V1(res_trans_crimes_c_pp_bigint2);
Datum
res_trans_crimes_c_pp_bigint2(PG_FUNCTION_ARGS)
{
...
PG_FUNCTION_INFO_V1(finalize_trans_crimes_c_pp_bigint2);
Datum
finalize_trans_crimes_c_pp_bigint2(PG_FUNCTION_ARGS)
{               
